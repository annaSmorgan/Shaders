#include "stdafx.h"
#include "..\include\DeferredRender.h"
...
bool DeferredRender::onCreate(unsigned int m_windowWidth, unsigned int m_windowHeight)
{
	// initialise the Gizmos helper class
	Gizmos::create();

	//Load the shaders for this program
	m_fbo_vertexShader = Utility::loadShader("./shaders/vertexDR.glsl", GL_VERTEX_SHADER);
	m_fbo_fragmentShader = Utility::loadShader("./shaders/fragmentDR.glsl", GL_FRAGMENT_SHADER);
...
void DeferredRender::Update(float a_deltaTime, unsigned int m_windowWidth, unsigned int m_windowHeight, GLFWwindow* m_window)
{
...
void DeferredRender::Draw(unsigned int m_windowWidth, unsigned int m_windowHeight)
{
	glBindFramebuffer(GL_FRAMEBUFFER, m_fbo);
