...
Reflections::Reflections() //attempted to make water with this but goes weird with two models
{
...
bool Reflections::onCreate(unsigned int m_windowWidth, unsigned int m_windowHeight)
{
...
void Reflections::Update(float a_deltaTime, unsigned int m_windowWidth, unsigned int m_windowHeight)
{
...
void Reflections::Draw(unsigned int m_windowWidth, unsigned int m_windowHeight)
{
	glBindFramebuffer(GL_FRAMEBUFFER, m_fbo);
