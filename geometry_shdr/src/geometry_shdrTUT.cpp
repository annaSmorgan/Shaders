...
GeometryShdrTUT::GeometryShdrTUT()
{
...
void GeometryShdrTUT::Update(float a_deltaTime)
{
...
bool GeometryShdrTUT::LoadImageFromFile(std::string a_filePath, unsigned int& a_textureID)
{
