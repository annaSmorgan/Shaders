...
static const unsigned int fbx_max_dir_path = 1024;
...
struct FBXMaterial
{
	...
	char			textureFilenames[TextureTypes_Count][fbx_max_dir_path];		// Filename (not path!)
...
inline FBXMaterial::FBXMaterial() 
	...
	emissive(0,0,0,0)
{
	memset(name,0, fbx_max_dir_path);
	memset(textureFilenames,0,TextureTypes_Count*fbx_max_dir_path);
